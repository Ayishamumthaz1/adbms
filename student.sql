...
select student_name,department from student order by student_name desc;
...
create view student_details as select student_name,id from student;
...
update student set admission_no=1156 where id=1;
update student set admission_no=1178 where id=2;
update student set admission_no=1158 where id=3;
update student set admission_no=1768 where id=4;
update student set admission_no=1987 where id=5;
update student set admission_no=1467 where id=6;
update student set admission_no=1246 where id=7;
update student set admission_no=1984 where id=8;
update student set admission_no=1192 where id=9;
update student set admission_no=1939 where id=10;
select * from student;
alter table student add column email varchar(20)unique;
update student set email="ayisha@gmail.com" where id=1;
update student set email="rena@gmail.com" where id=2;
update student set email="fathima@gmail.com" where id=3;
update student set email="shabna@gmail.com" where id=4;
update student set email="haneena@gmail.com" where id=5;
update student set email="krishna@gmail.com" where id=6;
update student set email="priya@gmail.com" where id=7;
update student set email="archana@gmail.com" where id=8;
update student set email="siva@gmail.com" where id=9;
update student set email="anu@gmail.com" where id=10;